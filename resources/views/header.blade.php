                     ...
                     <div class="col-md-6">
                        <div class="right_top_section">
                           ...
                           <ul class="social-icons pull-left">
                              <li><a class="facebook" href="https://www.facebook.com/purvia.shah.7"><i class="fa fa-facebook"></i></a></li>
                              <li><a class="twitter" href="images/instagram.png"><i class="fa fa-twitter"></i></a></li>
                           ...
                           <ul class="login">
                              ...
                              <li>
                                 <div class="cart-option">
                                    <a href="\registration"><i class="fa fa-shopping-cart"></i>Register</a>
                                 </div>
                              </li>
                           </ul>
                           <!-- end button section -->
